...
public static void main(String[] args) {
	...
	e1.ekranaBas(); //yukarda mantigi anlatildi return basma yapmaz sen basacaksin!
					//void oldugu icin ekranaBas mesela public string ekrana bas olsaydi String ekran=e1.ekranaBas()yapacaktik.Geri donus alan fonksiyon oldugu için bir degiskene atayip sonra bastirilabilirdi
